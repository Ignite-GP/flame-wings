...
Version:    1.7.0
Release:    1%{?dist}
Summary:    The server control plane for Flame Panel. Written from the ground-up with security, speed, and stability in mind.
BuildArch:  x86_64
License:    MIT
...
%description
Wings is Flame's server control plane, built for the rapidly
...
system to remain free of Flame specific dependencies, and
...
[Unit]
Description=Flame Wings Daemon
...
- specfile by Capitol Hosting Solutions, Upstream by Flame
